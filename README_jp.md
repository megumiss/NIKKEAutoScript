...
『勝利の女神：NIKKE』の自動デイリースクリプトです。PC／Android実機／ARMエミュレーターをサポートしています（**中国本土版を除く**）。[NIKKEAutoScript](https://github.com/takagisanmie/NIKKEAutoScript) からフォークされたプロジェクトです。
...
- **収穫**: 回収、殲滅、メールボックス
- **デイリー**: デイリーガチャ、デイリー、シーズンパス、相談、ショップ、スクラップショップ、花絮鑑賞会
- **前哨基地**: 派遣、解放、シンクロデバイス、リサイクルルーム、基地ストーリー
- **方舟**: シミュレーションルーム、オーバークロック、企業タワー、異常インターセプト、ルーキーアリーナ、特殊アリーナ、特殊アリーナ監視、チャンピオンアリーナ
- **期間限定作戦**: 協同戦闘、ソロレイド、同盟レイド
- **ストーリーイベント**: ストーリーイベント、自動マップ進行、自動掃討、ミニゲームデイリー、ショップ購入
- **地表**: 地表デイリー
- **Blablalink**: デイリーミッション、CDK自動交換、ポイント交換、ワンクリックログインによるCookie自動取得、Cookie自動更新
- **無料ギフト**: STEPUPギフト、デイリーギフト、ウィークリーギフト、マンスリーギフト
- **データチャート**: アイテム統計、インターセプト統計
- **ツール**: 自動タワー、半自動クリック（半自動メインストーリー）、ハイライト閲覧、CDK交換、画面回転、Hosts変更、イベントカウントダウン
- **対応プラットフォーム**: PCクライアント、Android実機、ARMエミュレーター；PCマルチモニター対応、VDD仮想ディスプレイ；ゲームウィンドウのバックグラウンド制御
- **スケジュールと制御**: タスクの実行周期／時間／有効化を一元管理するスケジュール設定；タスク自動起動、ホットキーカスタム；複数インスタンスの順次実行
- **その他**: 自動更新・定期更新；複数インスタンス同時起動；ゲーム多重起動；Dockerデプロイ；通知

---

## クイックスタート

- インストール：[Wiki インストールガイド](https://github.com/megumiss/NIKKEAutoScript/wiki/Installation-Guide)
- 使い方：[Wiki PCクライアント利用ガイド](https://github.com/megumiss/NIKKEAutoScript/wiki/Usage-Guide-PC-Client)

### デモ動画

- [インストールデモを見る](https://www.bilibili.com/video/BV1rqWczJECp)
- [機能デモを見る](https://www.bilibili.com/video/BV1YMbrzFE4g)

### GUIプレビュー

![GUIプレビュー](https://raw.githubusercontent.com/megumiss/NIKKEAutoScript/master/doc/assets/gui.png)
...
- [Wiki エラー解決](https://github.com/megumiss/NIKKEAutoScript/wiki/Error-Handling)

### サポート

- [GitHub Issues](https://github.com/megumiss/NIKKEAutoScript/issues) に問題を報告する
- QQグループに参加: [823265807](https://qm.qq.com/q/ibQKuQI9Ko)
- TGグループに参加: [Telegram](https://t.me/+D-Pguv_oapwyMjhl)
...
- スクリプトフレームワーク [AzurLaneAutoScript](https://github.com/LmeSzinc/AzurLaneAutoScript) に感謝
- PC対応コード [March7thAssistant](https://github.com/moesnow/March7thAssistant) に感謝
...
- [Nikke-CDK-Tool](https://github.com/Small-tailqwq/Nikke-CDK-Tool)（CDK収集／交換）

---

## 💖 支援

このプロジェクトが気に入ったら、作者に「蜜雪氷城（Mixue Ice Cream）」を一杯おごってください 🍦

あなたの支援が、作者が開発とメンテナンスを続ける原動力です 🚀
...
- 自動化スクリプトの使用は『勝利の女神：NIKKE』の利用規約に違反する可能性があり、アカウントの制限・停止のリスクがあります。すべて自己責任でご判断ください。
- 本プロジェクトは学習・技術交流を目的として提供され、いかなる保証も行いません。利用によって生じたアカウント・端末・データの損失について、作者は一切の責任を負いません。
- 本プロジェクトは非営利のオープンソースであり、SHIFT UP、テンセント / Level Infinite とは一切関係ありません。ゲーム関連素材の著作権は各権利者に帰属します。
- ダウンロードおよび使用をもって、上記の条項に同意したものとみなします。同意いただけない場合は直ちに使用を中止してください。
