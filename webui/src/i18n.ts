...
export const staticLabels: Record<string, Record<string, string>> = {
  ...
  '执行时间': { 'en-US': 'Run schedule', 'ja-JP': '実行時間' },
  ...
  '仅作用于每周任务': { 'en-US': 'Applies to weekly tasks only', 'ja-JP': '毎週タスクのみに適用' },
  '每日任务将设置为全部时间点；每周/每月任务使用第一个时间点': { 'en-US': 'Daily tasks get all time points; weekly/monthly tasks use the first one.', 'ja-JP': '毎日タスクは全ての時間帯に設定され、毎週/毎月タスクは最初の時間帯を使用します。' },
