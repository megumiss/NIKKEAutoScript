export type Instance = { name: string; state: number; mod: string; current_task?: string; next_task?: string; remark?: string; avatar?: string }
...
export type Announcement = { id: string; date: string; title: string; type: string; content: string; pinned: boolean; read: boolean }
