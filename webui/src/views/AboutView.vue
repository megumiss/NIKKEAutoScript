...
<template>
  <section class="view">
    <article class="card about-panel">
      ...
      <h3><AppIcon name="lightbulb" :size="18" /> Need help / 寻求帮助</h3>
      <p>
      ...
      <h3>Support / 支持项目</h3>
      <p>
        If you like this project, you can buy the author a cup of Mixue Ice Cream <AppIcon name="coffee" :size="15" /><br>
        如果喜欢本项目，可以送作者一杯蜜雪冰城<AppIcon name="coffee" :size="15" /><br>
        Your support is the motivation for the author to develop and maintain the project <AppIcon name="rocket" :size="15" /><br>
        您的支持就是作者开发和维护项目的动力<AppIcon name="rocket" :size="15" />
      </p>
      ...
      <div class="about-disclaimer">
        <h3><AppIcon name="alert-triangle" :size="18" /> Disclaimer / 使用风险与免责声明</h3>
        <p>
