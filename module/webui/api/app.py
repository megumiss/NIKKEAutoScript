...
from . import (routes_bla, routes_calendar, routes_config, routes_deploy, routes_device, routes_instances, routes_logs,
               routes_maintenance, routes_notify, routes_preview, routes_proxy, routes_schedule, routes_serial,
